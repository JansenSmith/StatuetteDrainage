...
def statuette_url = "https://github.com/JansenSmith/StatuetteDrainage/releases/download/0.1.0/african.woman.part.4.stl"

//File foo = DownloadManager.download("0.1.0", statuette_url, (long)16, "~/bin", "african.woman.part.4.stl", "african.woman.part.4.stl")

CSG statuette = ScriptingEngine.gitScriptRun(
...
statuette = statuette.toZMin()
//CSG plate = new Cube(200,200,5).toCSG().toZMin()
//statuette_plate = statuette.intersect(plate)

////create a rounded cube
//base = new RoundedCube(	110,// X dimention
//				125,// Y dimention
//				1000//  Z dimention
//				)
//				.resolution(res+1)
...
////				.movey(-90)
//
////statue_cutout_back = statuette_plate.movez(-5)
//
